...
<?php 
    ...
    switch ($menu) {
        ...
        case 'pembayaran':include 'page/pembayaran/table.php'; break;
...
<script>
    function sum() {
        var sum = 0;
        var tagihan = parseInt.getElementById("total");
        var bayar = parseInt.getElementById("bayar");
        sum = bayar - tagihan;
        $(".modal-body .form-group #kembali").val( sum );
        // return sum;
    }
</script>
...
<?php
switch($menu){
    case 'pembayaran':include 'page/pembayaran/modal.php';break;
}
